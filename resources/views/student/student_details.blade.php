    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header pb-0">
                <h5 class="modal-title" id="userDataModalLabel"> <span class="student-name"></span> Details</h5>
            ...
            <div class="modal-body">
                <form class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="phone" readonly disabled>
                    </div>

                    <div class="col-md-12">
                        <label for="birth_date" class="form-label">Birth Date</label>
                        <input type="date" class="form-control" id="birth_date" readonly disabled>
                    </div>
                    <div class="col-md-12">
