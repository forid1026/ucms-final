        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <div>
                        <h6 class="mb-1">Add Semester</h5>
                    </div>
                </div>
            </div>
            <div class="card-body p-4">
                <form id="basicForm" action="{{ route('store.student') }}" method="POST" enctype="multipart/form-data"
                    autocomplete="off">
                    @csrf
                                ...
                                <div class="mb-3">
                                    <div class="form-group">
                                        <input  type="text" maxlength="11" name="username"
                                            ...
                                            data-parsley-error-message="Username is Required" placeholder="Student ID">
