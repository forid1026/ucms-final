        ...
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
                    ...
                    <img src="{{ asset('upload/student_images/' . $studentData->photo) }}" class="user-img"
                        alt="user avatar">
                    <div class="user-info">
                        <p class="user-name mb-0">{{ $studentData->name }}</p>
                        <p class="designattion mb-0">{{ $studentData->email }}</p>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item d-flex align-items-center"
                            href="{{ route('change.student.password') }}"><i class="bx bx-cog fs-5"></i><span>Change
                                Password</span></a>
                    </li>
