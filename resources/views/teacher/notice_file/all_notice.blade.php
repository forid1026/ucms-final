                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="dropdown ms-auto">
                                <a href="{{ route('add.notice.teacher') }}" class="btn btn-sm btn-info px-4 radius-30">
                                            ...
                                            <td>
                                                <div class="d-flex order-actions">
                                                    <a type="button" data-bs-toggle="modal"
                                                        data-bs-target="#noticeDataModal" data-title="{{ $notice->title }}"
                                                    ...
                                                    <a href="{{ route('edit.notice.teacher', $notice->id) }}"
                                                        class="text-info ms-3"><i class="bx bxs-edit"></i>
                                                    </a>
                                                    <a id="delete"
                                                        href="{{ route('delete.notice.teacher', $notice->id) }}"
