        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <form id="basicForm" action="{{ route('update.section') }}" method="POST" autocomplete="off">
                        @csrf
                        ...
                        @endif
                        <input type="text" name="id" value="{{ $sectionInfo->id }}">
                                        ...
                                        <select class="form-control" name="semester_id" id="semester_id" required
                                            ...
                                            @foreach ($semesters as $semester)
                                                <option value="{{ $semester->id }}"
                                                    {{ $sectionInfo->semester_id == $semester->id ? 'selected' : '' }}>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        <input type="text" name="section_name" placeholder="Section Name"
                                            ...
                                            value="{{ $sectionInfo->section_name }}">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button type="submit" class="btn btn-sm btn-info">Update Section</button>
                                </div>
                            </div>
                        </div>
                    </form>
